    ...
    <div className="flex rounded-xl px-[34px] py-[18px] shadow-[0px_0px_47px_17px_#1A2F10D1] bg-gradient-to-r from-[#010101] via-[#2A471C] to-[#070F04]">
      ...
      <div className="flex flex-col">
        <div className="flex w-full justify-between items-center gap-[34px]">
          <div className="text-[40px] w-16 font-bold text-center">{h}</div>
          <div className="w-[1px] h-[25px] bg-[#ABABAB]"></div>
          <div className="text-[40px] w-16 font-bold text-center">{m}</div>
          <div className="w-[1px] h-[25px] bg-[#ABABAB]"></div>
          <div className="text-[40px] w-16 font-bold text-center">{s}</div>
        </div>
        <div className="flex w-full justify-between items-center">
          <div className="text-[#ABABAB] w-16 mt-2 text-[16px] font-medium text-center">
            Hours
          </div>
